        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <x-nav-link :href="route('dashboard')" :active="request()->routeIs('admin.dashboard.index') || request()->routeIs('itstaff.dashboard.index') || request()->routeIs('student.dashboard.index')">
                        {{ __('Dashboard') }}
                    </x-nav-link>
                    @if(Auth::user()->usertype === 'itstaff')
                        ...
                        <x-nav-link :href="route('calculate-saw')" :active="request()->routeIs('calculate-saw')">
                            {{ __('Calculate SAW') }}
                        </x-nav-link>
                    @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->usertype === 'itstaff')
                ...
                <x-responsive-nav-link :href="route('calculate-saw')" :active="request()->routeIs('calculate-saw')">
                    {{ __('Calculate SAW') }}
                </x-responsive-nav-link>
            @endif
            @if(Auth::user()->usertype === 'student')
