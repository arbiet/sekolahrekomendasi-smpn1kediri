                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('students.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="batch_year" class="mt-1 block w-full border p-2 rounded" value="{{ old('batch_year') }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="place_of_birth" class="mt-1 block w-full border p-2 rounded" value="{{ old('place_of_birth') }}">
                        </div>

                        <div class="mb-4">
                            <label for="date_of_birth" class="block text-sm font-medium text-gray-700">Date of Birth</label>
                            <input type="date" name="date_of_birth" class="mt-1 block w-full border p-2 rounded" value="{{ old('date_of_birth') }}">
                        </div>

                        <div class="mb-4">
                            <label for="nisn" class="block text-sm font-medium text-gray-700">NISN</label>
                            <input type="text" name="nisn" class="mt-1 block w-full border p-2 rounded" value="{{ old('nisn') }}">
                        </div>

                        <div class="mb-4">
                            <label for="phone_number" class="block text-sm font-medium text-gray-700">Phone Number</label>
                            <input type="text" name="phone_number" class="mt-1 block w-full border p-2 rounded" value="{{ old('phone_number') }}">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" class="mt-1 block w-full border p-2 rounded">
                                ...
                                <option value="graduated" @if(old('status') == 'graduated') selected @endif>Graduated</option>
                                <option value="dropped" @if(old('status') == 'dropped') selected @endif>Dropped</option>
                            </select>
                        </div>
